...
#define GESTURE_SENSITIVITY_1   80//50
#define GESTURE_SENSITIVITY_2   50//20
...
#define APDS9960_ID_3           0xA8 // This ID added inb databot revision2 as chines clone have this id
