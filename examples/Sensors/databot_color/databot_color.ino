/*
   This example demonstrate how to read RGB color value from databot2.0 APDS9960 sensor
*/
#include<databot2.h>
...
uint16_t RLight, GLight, BLight; //variables to store the color values
...
void loop() {
  apds.readRedLight(RLight);
  apds.readGreenLight(GLight);
  apds.readBlueLight(BLight);
  Serial.print("R: ");
  Serial.print(RLight);
  Serial.print("  G: ");
  Serial.print(GLight);
